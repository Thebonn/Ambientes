...
public class Splash extends javax.swing.JFrame {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    jProgressBar1.setString("Verificando as pastas...");

                    File file = new File("Arquivos/setups");
                    if (!file.exists()) {
                        jProgressBar1.setString("Criando as pastas...");
                        file.mkdirs();
                    }

                    jProgressBar1.setString("Verificando arquivos...");
                    ...
                    jProgressBar1.setString("Criando negócios...");
                    jProgressBar1.setIndeterminate(true);

                    
                    jProgressBar1.setString("Fazendo as coisas acontecerem...");
                    tocar = new Tocar();
                    
                    jProgressBar1.setString("Verificando atualizações...");
                    selecionarTexto();
                    mudatexto();

                    jProgressBar1.setString("Abrindo o Ambientes...");
                    Thread.sleep(2000);
    ...
    public void selecionarTexto() {
        ...
        try {
            ...
            jProgressBar1.setString("Aviso: Não há conexão com internet ou o servidor do pastebin está fora do ar");
        }
