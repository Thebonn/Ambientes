            ...
            public void run() {
                try {
                    while (true) {
                        ...
                        for (int i = 0; i < Tocar.gerenciadorDeSom.pl.length; i++) {
                            if (Tocar.gerenciadorDeSom.pl[i] != null) {
                                addTexto("Slot " + (i + 1) + " (" + Tocar.gerenciadorDeSom.pl[i].info + "): " + Tocar.gerenciadorDeSom.pl[i].posDoSomMS()+ "/" + Tocar.gerenciadorDeSom.pl[i].tamDoSomMS, txtPlay);
                            }
                        }
                        Thread.sleep(100);
                    }
...
//                    addTexto("\tDesativados: " + conversao(Tocar.desativados), txtDetalhes);
                    ...
                    addTexto("\tPode abrir janela de opções: " + Tocar.podeAbrir, txtDetalhes);
